        ...
        <div className={style.about}>
            <div className={style.aboutwrapper}>
                <div className={style.imgContainer}>
                    <img src="/images/grizzly.webp" alt="" />
                </div>
                <div className={style.textContainer}>
                    <h3>About me</h3>
                    <h2>Hi, I'm Ethan, a former engineer turned vegan culinary enthusiast! Eager to share with you the joys of crafting delicious vegan meals right in your home kitchen.</h2>
                    ...
                    <Link to='/aboutme'><span>More About Me</span></Link>
                </div>
